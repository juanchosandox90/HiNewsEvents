...
class BusinessFragment : Fragment() {
    ...
    private var businessNewsViewModel: BusinessViewModel? = null
    ...
    private fun getViewModelAndSetAdapter(view: View) {
        ...
        if(currentPage <= totalPage ){
            ...
            businessNewsViewModel = ViewModelProviders.of(this).get(BusinessViewModel::class.java)
            businessNewsViewModel!!.refreshData(currentPage)
            //observe viewModel live data
            businessNewsViewModel!!.businessNewsListData.observe(viewLifecycleOwner, Observer {
                if (it == null) {
                    showErrorLayout(view)
                } else {
                    ...
                    if( status != "ok"){
                        ...
                        recyclerView.adapter = BusinessNewsAdapter( it.articles )
    ...
    class BusinessNewsAdapter(private val newsArticleList: List<Article>) :
